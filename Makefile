...
APPNAME ="Litecoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),devault)
# dvt
DEFINES   += BIP44_COIN_TYPE=339 BIP44_COIN_TYPE_2=0 COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=128 COIN_FAMILY=1 COIN_COINID=\"DeVault\" COIN_COINID_HEADER=\"DEVAULT\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"DeVault\" COIN_COINID_SHORT=\"DVT\" COIN_KIND=COIN_KIND_DVT
APPNAME ="DeVault"
APP_LOAD_PARAMS += --path $(APP_PATH)
